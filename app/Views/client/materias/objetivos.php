...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="<?= site_url("materias/nuevo-objetivo/{$materia['materia_id']}") ?>"
                    ...
                    <tbody>
                        <?php foreach ($objetivos as $objetivo): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url("materias/editar-objetivo/" . $materia["materia_id"] . "/" . $objetivo['objetivo_id']) ?>"
                                        class="btn btn-sm btn-primary">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="#" class="btn btn-sm btn-danger btn-eliminar"
                                        data-url="<?= site_url("materias/eliminar-objetivo/{$materia['materia_id']}/{$objetivo['objetivo_id']}") ?>">
